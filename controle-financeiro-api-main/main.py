...
from exceptions import UserException, CategoryException, AccountException, TransactionException, GoalsException
...
def update_Goalsy(Goals_id: int, Goals: schemas.GoalsBase, db: Session = Depends(get_db)):
    try:
